...
BEGIN
    ...
    IF EXISTS(SELECT FROM information_schema.tables WHERE  table_schema = 'ledger_three' AND table_name = tablename) THEN
...
BEGIN
    ...
    SET search_path TO ledger_three, manucci_audit, public;
...
$$ LANGUAGE 'plpgsql'
    ...
    SET search_path TO ledger_three, pg_temp;
